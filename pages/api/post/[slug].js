...
const post = {
  ...
  profile: {
    ...
    youtube: "CodeBucks",
    avatar:
      "https://hackernoon.com/images/541r0RExUOQ3nFAQs7oJuST9Axf2-842316b.jpeg",
    twitter: "code_bucks",
  ...
  relatedStories: [
    ...
    },
    {
      ...
      slug:
        "we-built-a-face-and-mask-detection-web-app-for-google-chrome-836n33aq",
      mainImage:
        "https://hackernoon.com/images/oO6rUouOWRYlzw88QM9pb0KyMIJ3-82bk3j2w.png",
      tags: [
        "javascript",
        "tensorflowjs",
        "face-mask-detection",
      ...
      profile: {
        ...
        bio:
          "Skilled front end developer with 5+ years experience in developing web and SmartTV applications",
        avatar:
          "https://lh3.googleusercontent.com/a-/AOh14GhusYvdC0wNcF4K5CysAbKT-_tBWKvUBPjWBdEe=s96-c",
        github: "yantsishko",
        handle: "yantsishko",
      },
...
const handler = nc()
  .use(cors())
  .get((req, res) => {
    console.log(req.query.slug, 'req');
    console.log(post.slug, 'req');

    if (req.query.slug !== post.slug) {
